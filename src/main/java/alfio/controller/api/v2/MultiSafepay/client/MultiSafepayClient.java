package alfio.controller.api.v2.MultiSafepay.client;
import alfio.controller.api.v2.MultiSafepay.classes.*;
...
public class MultiSafepayClient {
	...
	// Edit this lines
	public static String api_key = ""; // Key provided by MultisafePay
	...
	public static JsonObject sendRequest(String url, String method,
		...
		if (method == "PATCH") // Workaround HttpURLConnection does not support
								// all modern methods like PATCH
		{
